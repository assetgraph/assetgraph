...
/** @typedef {import('./Asset').AssetConfig} AssetConfig */

/** @type {typeof import('iconv')} */
let iconv;

/** @type {typeof import('iconv-lite')} */
let iconvLite;
 ...
 * @default "utf-8"
 */
Text.prototype.defaultEncoding = 'utf-8';

Text.prototype.supportedExtensions = [
  '.txt',
  '.htaccess',
  '.md',
  '.rst',
...
Text.prototype.contentType = 'text/plain';

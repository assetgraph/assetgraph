...
var util = require('util'),
    ...
    cssnano = require('cssnano-paras20xx'),
...
extendWithGettersAndSetters(Css.prototype, {
    ...
    _updateText: function (forceUpdateSourceMap) {
        var sourceMapsEnabled = !this.assetGraph || this.assetGraph.sourceMaps !== false;
...
Css.cloneWithRaws = function (original) {
    ...
    (function reattachRaws(clone, original) {
        ...
        if (clone.nodes && original.nodes) {
            for (var i = 0 ; i < original.nodes.length && i < clone.nodes.length ; i += 1) {

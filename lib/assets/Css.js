            ...
            if (node.type === 'comment') {
                ...
                for (const childNode of node.nodes) {
                    ...
                    if (propertyWithImageUrlRegExp.test(propertyName)) {
                        AssetGraph.CssImage.prototype.findUrlsInPropertyValue(propertyValue).forEach((url, tokenNumber) => {
                    ...
                    if (propertyName === 'filter' || propertyName === '-ms-filter') {
                        AssetGraph.CssAlphaImageLoader.prototype.findUrlsInPropertyValue(propertyValue).forEach((url, tokenNumber) => {

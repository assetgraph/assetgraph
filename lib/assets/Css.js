...
extendWithGettersAndSetters(Css.prototype, {
    ...
    get text() {
        if (typeof this._text !== 'string') {
            if (this._parseTree) {
                if (this.isPretty) {
                    this._text = perfectionist.process(this._parseTree, { map: { inline: false, annotation: false } }).toString();
                    ...
                    }).process(postcss.parse(this._parseTree), { map: { inline: false, annotation: false } }).root.toString();
                } else {
    ...
    get parseTree() {
        if (!this._parseTree) {
            ...
            try {
                ...
                // postcss treats urls as file names, but it seems like we can fix it up after it has been mangled:

...
function OwnPreviousMap() {
    this.instantiate = function () {
        PreviousMap.apply(this, arguments);
    };
}
util.inherits(OwnPreviousMap, PreviousMap);
...
extendWithGettersAndSetters(Css.prototype, {
    ...
    get parseTree() {
        if (!this._parseTree) {
            ...
            this._previousMap = new OwnPreviousMap();
            try {
                this._parseTree = postcss.parse(this.text, {
                    ...
                    source: this.urlOrDescription,
                    from: this.urlOrDescription
                });
            } catch (e) {

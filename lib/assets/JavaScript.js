...
extendWithGettersAndSetters(JavaScript.prototype, {
    ...
    findOutgoingRelationsInParseTree: function () {
        ...
        if (assetGraph && assetGraph.requireJsConfig && this.incomingRelations.some(function (incomingRelation) {return /^JavaScript(?:RequireJsCommonJsCompatibilityRequire|ShimRequire|Amd(?:Define|Require))$/.test(incomingRelation.type);})) {

...
//> JSON.stringify(require('uglify-js').parser.parse("void(0);one.include('foo.js');"));
//'["toplevel",[["stat",["unary-prefix","void",["num",0]]],["stat",["call",["dot",["name","one"],"include"],[["string","foo.js"]]]]]]'

//> JSON.stringify(require('uglify-js').parser.parse("void(0),one.include('foo.js');"));
//'["toplevel",[["stat",["seq",["unary-prefix","void",["num",0]],["call",["dot",["name","one"],"include"],[["string","foo.js"]]]]]]]'

        ...
        estraverse.traverse(parseTree, {
            enter: function (node, parentNode) {
                ...
                if (node.type === 'CallExpression') {
                    ...
                    } else if (node.callee.type === 'Identifier' && node.callee.name === 'INCLUDE') {
                    ...
                    } else if (node.callee.type === 'Identifier' && node.callee.name === 'GETSTATICURL' && node.arguments.length === 1 && node.arguments[0].type === 'Literal' && typeof node.arguments[0].value === 'string') {

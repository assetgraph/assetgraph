                ...
                if (node[1][0] === 'name' && node[1][1] === 'INCLUDE') {
                    ...
                    arrayNode[1].forEach(function (arrayItemAst) {
                        if (arrayItemAst[0] !== 'string') {
                            var constantFoldedArrayItemAst = foldConstant(arrayItemAst);
                            if (constantFoldedArrayItemAst[0] === 'string') {
                                Array.prototype.splice.apply(arrayItemAst, [0, arrayItemAst.length].concat(constantFoldedArrayItemAst));
                            }
                        }
                        if (arrayItemAst[0] === 'string') {

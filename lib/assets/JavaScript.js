    ...
    _getEscodegenOptions() {
        ...
        return {
            format: {
                ...
                space: typeof outputOptions.space === 'undefined' ? (this.isPretty || !this._toBeMinified ? ' ' : '') : outputOptions.space,
                newline: typeof outputOptions.newline === 'undefined' ? (this.isPretty || !this._toBeMinified ? '\n' : '') : outputOptions.newline,
                semicolons: typeof outputOptions.semicolons === 'undefined' ? this.isPretty || !this._toBeMinified : outputOptions.semicolons,
                parentheses: typeof outputOptions.parentheses === 'undefined' ? this.isPretty || !this._toBeMinified : outputOptions.parentheses,
        ...
        try {
            estraverse.traverse(this.parseTree, {
                enter(node) {
                    ...
                    const origStart = sourceMapConsumer.originalPositionFor(node.loc.start);

                ...
                if (node[0] === 'stat' && Array.isArray(node[1]) &&
                    ...
                    if (methodName === 'setPath') {
                        ...
                        if (args.length === 0) {
                            ...
                            if (args[0][0] === 'string') {
                                stringNodes = [args[0]];
                            } else if (args[0][0] === 'array' && args[0][1].every(function (arg) {return arg[0] === 'string';})) {
                                stringNodes = args[0][1];
                            } else {
                                firstErrorOrNull = firstErrorOrNull || new Error('Unsupported Ext.require syntax: first argument must be string or array of strings');
                            }

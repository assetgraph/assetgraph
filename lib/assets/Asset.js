...
extendWithGettersAndSetters(Asset.prototype, {
    ...
    get urlOrDescription() {
        var rootUrl = this.assetGraph && this.assetGraph.root;
        function makeRelativeToAssetGraphRootUrlIfPossible(url) {
        ...
        return this.url ? makeRelativeToAssetGraphRootUrlIfPossible(this.url) : ('inline ' + this.type + (this.nonInlineAncestor ? ' in ' + makeRelativeToAssetGraphRootUrlIfPossible(this.nonInlineAncestor.url) : ''));
    }
});

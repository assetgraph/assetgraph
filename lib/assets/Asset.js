    ...
    if (!this._inferredType) {
      ...
      if (
        ...
        if (commonTargetType) {
          if (
            this._inferredType &&
            !AssetGraph[commonTargetType].prototype['is' + this._inferredType]
          ) {
            this._warnIncompatibleTypes([this._inferredType, commonTargetType]);
          } else {
            this._inferredType = commonTargetType;
          }
        }
      }

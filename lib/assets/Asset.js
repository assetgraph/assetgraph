...
extendWithGettersAndSetters(Asset.prototype, {
    ...
    clone: function (incomingRelations, preserveUrl) {
        ...
        if (this.type === 'JavaScript' && this._parseTree) {
            constructorOptions.parseTree = espurify.customize({ extra: [ 'loc', 'range', 'source_type', 'comments', 'raw', 'trailingComments', 'leadingComments' ] })(this._parseTree);

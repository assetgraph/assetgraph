    ...
    if (!this._hasInitialized) {
        ...
        if (config.url) {
            ...
            if (!urlEndsWithSlashRegExp.test(this._url)) {
                var urlObj = urlTools.parse(this._url);
        ...
        if (this.isLoaded) {
            ...
            if (url) {
                ...
                if (protocol === 'javascript') {
                    ...
                    this.assetGraph.emit('warn', new Error(['No resolver found for protocol: ' + protocol, '\tIf you think this protocol should exist, please contribute it here:', '\thttps://github.com/Munter/schemes#contributing'].join('\n')));
                }
            }
        } else {

...
class Asset extends EventEmitter {
   ...
   *
   * @constructor
   * @param {Object} config Configuration for instantiating an asset
   *
   * @param {Buffer} [config.rawSrc] `Buffer` object containing the raw source of the asset
   *
   * @param {String} [config.contentType] The Content-Type (MIME type) of the asset. For
   * subclasses of Asset there will be a reasonable default.
   *
   * @param {String} [config.url] The fully qualified (absolute) url of the asset.

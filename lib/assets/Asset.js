...
extendWithGettersAndSetters(Asset.prototype, {
    ...
    markDirty: function () {
        ...
        if (this.isInline && this.incomingRelations) {
            // Cascade dirtiness to containing asset
    ...
    /**
     * asset.incomingRelations (array)
     * ===============================
     *
     * The relations pointing at this asset. Maintained by the
     * AssetGraph instance.
     *
     * @api public
     */
    ...
    /**
     * asset._refreshInlineRelations()
     * ===============================
     *
     * Prepare for serialization by recursively re-inlining inline
     * assets that have been marked dirty.
     *
     * @api private
     */
    _refreshInlineRelations: function (asset) {
        this.outgoingRelations.forEach(function (relation) {
            if (relation.to.isAsset && relation.to.isInline) {
                relation.to._refreshInlineRelations();

...
extendWithGettersAndSetters(Asset.prototype, {
     ...
     * ===============================
     *
     * The file name extension for the asset (String). Automatically
     * kept in sync with the url, but saved if the asset is inlined.
     *
     ...
     * order.
     *
     * Will also update the `extension` property if one can be
     * extracted from the new url.
     *

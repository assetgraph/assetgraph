...
/** @typedef {import('../relations/HtmlRelation')} HtmlRelation */
/** @typedef {import('../assets/Asset')} Asset */
/** @typedef {import('../assets/Asset').AssetConfig} AssetConfig */

/**
 * @typedef {object} HtmlAssetConfigSpecifics
 * @prop {boolean} [isFragment]
 *
 * @typedef {AssetConfig & HtmlAssetConfigSpecifics} HtmlAssetConfig
 */

...
extendWithGettersAndSetters(Html.prototype, {
    ...
    set text(text) { // Duplicate of 'text' getter of assets.Text
        ...
        while (queue.length) {
            ...
            if (node.nodeType === node.ELEMENT_NODE) {
                ...
                if (matchNonInternetExplorerConditionalComment) {
                    ...
                    if (!foundEndMarker) {
                        console.warn("assets.Html: Skipped conditional comment because no end marker was found: " + node.outerHTML);
                    }
                } else {
                    // <!--[if IE 6]> .... <![endif]-->

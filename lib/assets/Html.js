            ...
            if (node.nodeType === node.ELEMENT_NODE) {
                ...
                if (nodeName === 'script') {
                    ...
                    if (!type || type === 'text/javascript' || type === 'text/coffeescript') {
                        ...
                        if (src) {
                            if (isRelationUrl(src)) {
                                ...
                                if (/(^|\/)require(?:-\w+)?\.js$/.test(src) && node.hasAttribute('data-main')) {
                            ...
                            outgoingRelations.push(new relations.HtmlScript({
                                from: this,
                                to: new (require(type === 'text/coffeescript' ? './CoffeeScript' : './JavaScript'))({
                    ...
                    if (node.hasAttribute('rel')) {
                        ...
                        if (/(?:^| )stylesheet(?:\/less)?(?:$| )/i.test(rel) && isRelationUrl(node.getAttribute('href'))) {
                            outgoingRelations.push(new relations.HtmlStyle({
                                from: this,
                                to: {

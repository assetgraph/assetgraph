...
extendWithGettersAndSetters(Html.prototype, {
    ...
    _attachNode: function (node, position, adjacentNode) {
        if (position !== 'before' && position !== 'after') {
            throw new Error("assets.Html._attachNodeNextToOtherNode: The 'position' parameter must be either 'before' or 'after'");
        }
        var parentNode = adjacentNode.parentNode;
        if (!parentNode) {
            throw new Error("assets.Html.attachRelation: Adjacent relation has no parentNode property.");
        }
        if (position === 'after') {

    ...
    return function compileCoffeeScriptToJavaScript(assetGraph) {
        ...
        try {
            ...
            return process.nextTick(function () {
                cb(new Error('transforms.compileCoffeeScriptToJavaScript: The "coffee-script" module is required. Please run "npm install coffee-script" and try again (tested with version 1.2.0).'));
            });
        }

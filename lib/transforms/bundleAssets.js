...
function makeBundle(assetGraph, queryObj, assetsToBundle, cb) {
    ...
    seq.ap(assetsToBundle)
        ...
        .seq(function () {
            ...
            assetGraph.findRelations({from: assetsToBundle}).forEach(function (outgoingRelation) {
...
module.exports = function (queryObj, bundleStrategyName) {
    ...
    return function bundleAssets(assetGraph, cb) {
        bundleStrategyByName[bundleStrategyName](assetGraph, queryObj, passError(cb, function () {

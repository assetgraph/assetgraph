            ...
            for (const htmlStyle of assetGraph.findRelations({type: 'HtmlStyle', from: htmlAsset})) {
                ...
                if (hasCssImagesToInline) {
                    if (minimumIeVersion && ieVersion > minimumIeVersion) {
                        ...
                        const internetExplorerConditionalCommentBody = htmlConditionalComment.to;
                        const htmlStyleInInternetExplorerConditionalComment = internetExplorerConditionalCommentBody.addRelation({
                            type: 'HtmlStyle',
                        ...
                        // FIXME: Accept media attribute when attaching HtmlStyle and CssImport?

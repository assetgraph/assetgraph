...
exports.addPNG8FallbackForIE6 = function () {
    return function addPNG8FallbackForIE6(assetGraph, cb) {
        var imageInfosById = {};
        assetGraph.findRelations('type', 'CSSBackgroundImage').filter(function (relation) {
        ...
        step(
            ...
            error.passToFunction(cb, function (pngQuantedImageSrcs) {
                imageInfos.forEach(function (imageInfo, i) {
                    ...
                    assetGraph.registerAsset(pngQuantedAsset);
                    ...
                    if (assetGraph.findRelations('to', imageInfo.asset).length === 0) {
                        assetGraph.unregisterAsset(imageInfo.asset);
                    }
                });
                process.nextTick(cb);
            })

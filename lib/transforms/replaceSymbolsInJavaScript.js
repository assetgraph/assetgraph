                ...
                if (replacementAst) {
                    ...
                    stack.some(function (node, stackIndex) {
                        ...
                        if (originalNode === node) {
                            ...
                            if (node instanceof uglifyJs.AST_Sub && !(node.property instanceof uglifyJs.AST_Constant))   {
                                return true;
                            } else {
                                var propVal = (node instanceof uglifyJs.AST_Dot) ? node.property : String(node.property.value);

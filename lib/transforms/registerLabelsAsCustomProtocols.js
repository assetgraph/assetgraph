...
module.exports = function (labelDefinitionsObj) {
    var labelByName = {};
    if (_.isString(labelDefinitionsObj) || _.isArray(labelDefinitionsObj)) {
        _.flatten(labelDefinitionsObj).forEach(function (keyEqualsValueStr) {
    ...
    } else if (typeof labelDefinitionsObj === 'object') {
        labelByName = labelDefinitionsObj;
    }

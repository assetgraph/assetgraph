        ...
        seq()
            ...
            .parEach(function (originalHTMLAsset) {
                ...
                seq()
                    ...
                    .extend(assetGraph.findRelations({type: 'HTMLScript', from: originalHTMLAsset, to: {url: query.defined}}))
                    ...
                    .parEach(function (localeId) {
                        ...
                        i18nTools.extractAllKeysForLocaleFromI18NAssets(localeId, subgraph.findAssets({type: 'I18N'}), error.passToFunction(callback2, function (allKeys) {
                            seq()
                                .extend(assetGraph.findRelations({type: 'HTMLScript', from: localizedHTML, to: _.values(nonInlineJavaScriptsToCloneById)}))
                                .parEach(function (htmlScript) {
                                    htmlScript.to.getParseTree(this);
                                })

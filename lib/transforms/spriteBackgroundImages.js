...
exports.spriteBackgroundImages = function () {
    return function spriteBackgroundImages(err, assetGraph, cb) {
        ...
        assetGraph.findRelations({type: 'CSSSpritePlaceholder'}).forEach(function (cssSpritePlaceholder) {
            ...
            var spriteGroupName = cssSpritePlaceholder.to.rawSrc.selectorForGroup; // Eeh
            ...
            function () {
                ...
                _.each(spriteGroups, function (spriteGroup, spriteGroupName) {
                    var callback = group(),
                        ...
                        spriteInfo = spriteGroup.cssSpritePlaceholder ? spriteGroup.cssSpritePlaceholder.to.rawSrc : {};
                    step(
                        function () {
                        ...
                        error.passToFunction(cb, function (spriteBuffer) {
                            ...
                            if (spriteGroup.cssSpritePlaceholder) {
                                ...
                                cssRule.style.setProperty('background-image', 'url(...)',
                                                          spriteGroup.cssSpritePlaceholder.to.rawSrc.important && 'important');

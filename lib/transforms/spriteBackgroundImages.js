                    ...
                    step(
                        ...
                        error.passToFunction(cb, function (spriteBuffer) {
                            ...
                            if (spriteGroup.cssSpritePlaceholder) {
                                var cssValue = 'url(...)'; // FIXME
                                if (spriteGroup.cssSpritePlaceholder.to.originalSrc.important) {
                                    cssValue += ' !important';
                                }
                                spriteGroup.cssSpritePlaceholder.cssRule.style['background-image'] = cssValue;

            ...
            function () {
                ...
                _.each(spriteGroups, function (spriteGroup, spriteGroupName) {
                    var callback = group(),
                        ...
                        spriteInfo = spriteGroup.cssSpritePlaceholder ? spriteGroup.cssSpritePlaceholder.to.parseTree : {};
                    step(
                        function () {
                            var innerGroup = this.group();
                            imageInfos.forEach(function (imageInfo) {
                                imageInfo.asset.getCanvasImage(innerGroup());
                            });
                        },
                        ...
                        error.passToFunction(cb, function (spriteBuffer) {
                            ...
                            if (spriteGroup.cssSpritePlaceholder) {
                                var cssRule = spriteGroup.cssSpritePlaceholder.cssRule;
                                cssRule.style.setProperty('background-image', 'url(...)',
                                                          spriteGroup.cssSpritePlaceholder.to.parseTree.important && 'important');
                                ...
                                assetGraph.detachAndRemoveRelation(spriteGroup.cssSpritePlaceholder);
                                assetGraph.removeAsset(spriteGroup.cssSpritePlaceholder.to);
                            }
                            imageInfos.forEach(function (imageInfo) {

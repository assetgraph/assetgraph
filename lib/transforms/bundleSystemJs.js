    ...
    .then(function () {
        ...
        entryPointModules.forEach(function (entryPoint) {
            ...
            // entry point has conditionals
                ...
                if (commonVariationModules && commonVariationModules.length) {
                    bundles[commonVariationBundleName = generateBundleName('common-' + entryPoint.name, commonVariationModules)] = {
                ...
                Object.keys(conditionalEnv).forEach(function (condition) {
                    conditionalEnv[condition].forEach(function (conditionValue) {
                        ...
                        if (curModules && curModules.length) {
                            ...
                            bundles[independentConditionBundles[independentConditionBundles.length - 1]] = {
                                modules: curModules,
                                source: undefined,
                                sourceMap: undefined,
                                assetList: undefined
                ...
                entryPoint.conditionalVariations.forEach(function (variation) {
                    ...
                    independentConditionBundles.forEach(function (independentConditionBundle) {
                        ...
                        if (containsModules(entryPointBundleModules, independentConditionModules)) {
                            ...
                            entryPointBundleBundles.push(independentConditionBundle);
                        }
                    });
...
module.exports = function (options) {
    ...
    return function bundleSystemJs(assetGraph) {
        ...
        return bundleStrategy(builder, entryPointNames.map(function (entryPointName) {
            ...
            function addBundle(bundleId, occurrence, conditions) {
                ...
                if (occurrence.incomingRelation.type === 'HtmlServiceWorkerRegistration' || occurrence.incomingRelation.type === 'JavaScriptServiceWorkerRegistration' || occurrence.incomingRelation.type === 'JavaScriptWebWorker') {
            ...
            Object.keys(entryPointInfosByPageId).forEach(function (pageId) {
                ...
                entryPointInfosByPageId[pageId].forEach(function (occurrence, i) {
                    ...
                    var isCommonForEntryPointByBundleId = {};
                    entryPointBundles[0].bundles.forEach(function (bundleId) {
                        if (entryPointBundles.every(function (entryPointBundle) {return entryPointBundle.bundles.indexOf(bundleId) !== -1;})) {
                            addBundle(bundleId, occurrence, {});
                            isCommonForEntryPointByBundleId[bundleId] = true;
                        }
                    });
                    entryPointBundles.forEach(function (entryPointBundle) {
                        var conditions = entryPointBundle.conditions || {};
                        var bundleIds = entryPointBundle.bundles;
                        bundleIds.forEach(function (bundleId) {
                            if (!isCommonForEntryPointByBundleId[bundleId]) {
                                addBundle(bundleId, occurrence, conditions);
                            }
                        });
                    });
                });

        ...
        return Promise.all(allEntryPoints.map(function (entryPoint) {
            ...
            .then(function (conditionalEnv) {
                ...
                if (!conditionsCombinations.length) {
                    return getModuleTrace(entryPoint.name, { conditions: options.conditions || {}, traceConditionModules: false })
                ...
                return Promise.all(conditionsCombinations.map(function (conditions, index) {
                    return getModuleTrace(entryPoint.name, { conditions: Object.assign(Object.assign({}, conditions), options.conditions || {}), traceConditionModules: false })
                    .then(function (modules) {

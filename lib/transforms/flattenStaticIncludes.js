            ...
            assetGraph.findRelations({from: initialAsset, type: 'HTMLScript'}).forEach(function (htmlScriptRelation) {
                ...
                (function traversePostorder(asset) {
                    if (!seenAssets[asset.id]) {
                        assetGraph.findRelations({from: asset, type: ['JavaScriptStaticInclude', 'JavaScriptExtJS4Include']}).forEach(function (relation) {
                            ...
                            if (asset === htmlScriptRelation.to && relation.type === 'JavaScriptStaticInclude') {

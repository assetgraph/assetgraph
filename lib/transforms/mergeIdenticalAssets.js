...
module.exports = function (queryObj) {
    return function mergeIdenticalAssets(assetGraph) {
        ...
        assetGraph.findAssets(queryObj).forEach(function (asset) {
            var rawSrc = assetGraph.getAssetRawSrc(asset),
            ...
            if (md5sum in seenAssetsByMd5) {
                ...
                if (!identicalAsset.url) {
                    ...
                    assetGraph.setAssetUrl(identicalAsset, urlTools.resolveUrl(assetGraph.root, identicalAsset.id + identicalAsset.extension));
                }

...
module.exports = queryObj => {
    return function addCacheManifest(assetGraph) {
        for (const htmlAsset of assetGraph.findAssets(Object.assign({type: 'Html', isInline: false}, queryObj))) {
            ...
            assetGraph.eachAssetPostOrder(htmlAsset, {type: {$nin: ['HtmlAnchor', 'HtmlMetaRefresh', 'HtmlCacheManifest', 'HtmlConditionalComment', 'JavaScriptSourceUrl', 'JavaScriptSourceMappingUrl', 'JavaScriptSourceMap']}}, asset => {

            ...
            try {
                for (const entryPoint of entryPoints) {
                    ...
                    if (dataAlmond) {
                        ...
                        htmlScript.to = assetGraph.add({ url: assetGraph.resolveUrl(htmlScript.from.nonInlineAncestor.url, dataAlmond) });
                    ...
                    let sourceMap;
                    let bundleAssetUrl = 'file://' + baseUrl + (dataMain ? dataMain + '-' : '') + 'bundle.js';
                    if (sourceMapFileName) {
                        ...
                        sourceMap.file = '/' + urlTools.buildRelativeUrl(assetGraph.root, bundleAssetUrl);
                    ...
                    if (stats && stats.isFile()) {
                        ...
                        if (cssContents) {
                            ...
                            }, lastExistingHtmlStyle ? 'after' : 'first', lastExistingHtmlStyle);

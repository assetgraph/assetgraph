    ...
    return function subsetGoogleFonts(assetGraph, cb) {
        ...
        .queue(function moveSubsetAssetsToLocal(assetGraph) {
            Object.keys(htmlAssetTextByPropsMap).forEach(function (assetUrl) {
                ...
                var fontStyleSheetRelations = assetGraph.findRelations({ type: 'HtmlStyle', from: htmlAsset, to: { url: googleFontsUrlRegex } });
        ...
        .populate({ startAssets: { url: /google-font-subsets\/fonts-/ }, followRelations: { type: 'CssFontFaceSrc' } })

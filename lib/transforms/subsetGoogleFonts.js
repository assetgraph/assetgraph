...
function asyncLoadStyleRelationWithFallback(htmlAsset, originalRelation) {
    ...
    var injectionPointRelation = htmlAsset.outgoingRelations[0];
    ...
    console.log('debug', htmlAsset.outgoingRelations.slice().pop().toString());

    console.log('debug', htmlAsset.assetGraph.findRelations(
        {
            type: 'HtmlStyle',
...
module.exports = function (options) {
    ...
    var subsetPath = options.subsetPath || '/subfont/';
                        ...
                        googleFontSubsetCssRelationsByPage.forEach(function (fontStyleSheetRelations) {
                            ...
                            fontStyleSheetRelations.forEach(function (fontStyleSheetRelation) {
                                ...
                                cssAsset.outgoingRelations.forEach(function (fontRelation) {
                                    ...
                                    if (inlineSubsets) {
                                        ...
                                        fontAsset.url = pathModule.join(assetGraph.root, subsetPath, fileName);
                            ...
                            var fontStyleBundle = assetGraph.findAssets({
                                ...
                                url: function (assetUrl) {
                                    return typeof assetUrl === 'string' && assetUrl.indexOf(pathModule.join(assetGraph.root, subsetPath)) === 0;
                                },
                                text: bundleSource
                            })[0];
                            ...
                            if (!fontStyleBundle) {
                                ...
                                fontStyleBundle.url = pathModule.join(assetGraph.root, subsetPath, bundleFileName);
                        ...
                        googleFontStylesheets.forEach(function (googleFontStylesheet) {
                            googleFontStylesheet.incomingRelations.forEach(function (googleFontStylesheetRelation) {
                                ...
                                htmlParents.forEach(function (htmlParent) {
                                    asyncLoadStyleRelationWithFallback(htmlParent, googleFontStylesheetRelation);
                                });
                            });

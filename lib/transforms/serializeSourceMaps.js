...
module.exports = function () {
    return function (assetGraph) {
        assetGraph.findAssets({ type: 'JavaScript', isDirty: true }).forEach(function (javaScript) {
            ...
            javaScript.serializationOptions.sourceMap = false;
            // FIXME: This makes the parseTree a SourceMapGenerator, where it's actually supposed to be a SourceMapConsumer
            sourceMap.parseTree = javaScript.sourceMap;
        });
    };
};

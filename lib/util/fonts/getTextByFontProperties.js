...
function getMemoizedElementStyleResolver(fontPropRules, availableWeights) {
    ...
    var getComputedStyle = memoizeSync(function (node, idArray) {
        ...
        function traceProp(prop, startIndex) {
            ...
            // console.log('localFontPropRules', prop, startIndex, localFontPropRules[prop])
            ...
            for (var i = startIndex; i < localFontPropRules[prop].length; i += 1) {
                ...
                // console.log(prop, i, node.tagName, selectorWithoutPseudoClasses);
                ...
                if (isStyleAttribute || node.matches(selectorWithoutPseudoClasses)) {
                    ...
                    if (isStyleAttribute || selectorWithoutPseudoClasses === declaration.selector) {
                        ...
                        // console.log('recursing', prop, values);
        ...
        result['font-family'] = result['font-family'] && result['font-family'].map(unquote) || result['font-family'];
...
function getTextByFontProperties(htmlAsset, availableWeights) {
    ...
    // console.log('styledTexts', styledTexts);
    ...
    function expandPermutations(styledText, propertyNames) {
        ...
        // console.log(styledText, propertyNames);
    ...
    // console.log('styledTexts', JSON.stringify(styledTexts, undefined, 2));
    ...
    // console.log('multipliedStyledTexts', JSON.stringify(multipliedStyledTexts, undefined, 2));

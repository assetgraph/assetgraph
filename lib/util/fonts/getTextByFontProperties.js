...
function getMemoizedElementStyleResolver(
  ...
  var getComputedStyle = memoizeSync(
    function(node, idArray, pseudoElementName, parentTrace, predicates) {
      ...
      function traceProp(prop, startIndex, predicates) {
        ...
        for (var i = startIndex; i < localFontPropRules[prop].length; i += 1) {
          ...
          if (
            Object.keys(declaration.predicates).some(function(predicate) {
              return (
          ...
          if (
            ...
            if (predicatesToVary.length > 0) {
              ...
              createPredicatePermutations(
              ...
              ).forEach(function(predicatePermutation) {
                ...
                if (
                  ...
                  Object.keys(declaration.predicates).every(function(
                    predicate
                  ) {
                    return (
...
function expandAnimations(computedStyle, keyframesDefinitions) {
  if (computedStyle['animation-name'].length > 0) {
    ...
    if (animatedPropertyNames.length > 0) {
      ...
      expandPermutations(computedStyle, animatedPropertyNames).forEach(function(
        permutation
      ) {
...
function expandTransitions(computedStyle) {
  ...
  if (fontWeightTransitions.length > 0) {
    var hypotheticalFontWeightValuesInPseudoClassStates = computedStyle[
      'font-weight'
    ].filter(function(hypotheticalValue) {
      return Object.keys(hypotheticalValue.predicates).some(function(
        predicate
      ) {
        return (
    ...
    if (hypotheticalFontWeightValuesInPseudoClassStates.length > 0) {
      ...
      if (hypotheticalNonZeroTransitionDurations.length > 0) {
        ...
        hypotheticalNonZeroTransitionDurations.forEach(function(
          transitionDuration
        ) {
          fontWeightTransitions.forEach(function(fontWeightTransition) {
            hypotheticalFontWeightValuesInPseudoClassStates.forEach(function(
              hypotheticalFontWeightValueInPseudoClassStates
            ) {
              computedStyle['font-weight'].forEach(function(
...
function getTextByFontProperties(htmlAsset, memoizedGetCssRulesByProperty) {
  ...
  function adjustPossibleCountersAndListItemNumbers(
    ...
    ['counter-reset', 'counter-set'].forEach(function(propertyName) {
      var values = _.uniq(
        computedStyle[propertyName].map(function(
          hypotheticalCounterResetValue
        ) {
      ...
      values.forEach(function(value) {
        ...
        Object.keys(valueByCounterName).forEach(function(counterName) {
          (possibleCounterValuesByName[counterName] || [0]).forEach(function(
            possibleCounterValue
          ) {
    ...
    var counterIncrementValues = _.uniq(
      computedStyle['counter-increment'].map(function(
  ...
  var multipliedStyledTexts = _.flatten(
    styledTexts.map(function(styledText) {

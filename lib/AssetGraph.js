...
_.extend(AssetGraph.prototype, {
    ...
    inlineRelation: function (relation, cb) {
        ...
        that._refreshInlineRelations(relation.to, passError(cb, function () {
    ...
    _refreshInlineRelations: function (asset, cb) {
        ...
        seq(that.findRelations({from: asset, to: {url: AssetGraph.query.isUndefined}}))
            .parEach(function (relation) {
                var callback = this;
                that._refreshInlineRelations(relation.to, passError(callback, function () {
    ...
    getAssetText: function (asset, cb) {
        this._refreshInlineRelations(asset, passError(cb, function () {
            asset.getText(cb);
        }));
    },

    getAssetRawSrc: function (asset, cb) {
        this._refreshInlineRelations(asset, passError(cb, function () {
            asset.getRawSrc(cb);
        }));
    },

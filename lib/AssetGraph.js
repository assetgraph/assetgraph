...
_.extend(AssetGraph.prototype, {
    ...
    refreshRelationHref: function (relation) {
        ...
        if (relation.to.url) {
            var relativeUrl = urlTools.buildRelativeUrl(relation.baseAsset.url, relation.to.url);
    ...
    populateRelationsToExistingAssets: function (asset) {
        ...
        asset.createOriginalRelations().forEach(function (outgoingRelation) {
            var relativeUrl;
     ...
     * ==============================================
     *
     * Helper function for the relation.baseAsset getter.
     *

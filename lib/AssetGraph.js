...
AssetGraph.prototype = {
    ...
    createMatcherFunction: function (queryObj) {
        var that = this;
        ...
        var matchers = _.map(queryObj || {}, function (query, fieldName) {
            if (typeof query === 'function') {
                ...
                return function (obj) {
                    return query.test(obj[fieldName]);
                };
                ...
                var fieldMatcher = that.createMatcherFunction(query);
                return function (obj) {
    ...
    _query: function (type, queryObj) {
        ...
        if (shortestIndexLookup && numFields === 1) {
            ...
            return (shortestIndexLookup || that[type + 's']).filter(this.createMatcherFunction(queryObj));
        }
    },

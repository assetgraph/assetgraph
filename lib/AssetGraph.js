...
function AssetGraph(config) {
    ...
    this.resolverByProtocol = {
        data: require('./resolvers/data')(),
        file: require('./resolvers/file')(),
        http: require('./resolvers/http')(),
        https: require('./resolvers/http')()
    };
    this.defaultResolver = require('./resolvers/findParentDir')(); // FIXME: Make configurable

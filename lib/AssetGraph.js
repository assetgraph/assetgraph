...
_.extend(AssetGraph.prototype, {
    ...
    addAsset: function (asset) {
        ...
        asset.incomingRelations = asset.incomingRelations || [];
    ...
    removeAsset: function (asset, detachIncomingRelations) {
        ...
        delete asset.incomingRelations;
        affectedRelations.forEach(function (affectedRelation) {
    ...
    addRelation: function (relation, position, adjacentRelation) { // position and adjacentRelation are optional
        ...
        relation.to.incomingRelations = relation.to.incomingRelations || [];
        relation.to.incomingRelations.push(relation);
    ...
    removeRelation: function (relation) {
        ...
        var incomingRelationIndex = relation.to.incomingRelations.indexOf(relation);
        if (incomingRelationIndex === -1) {
            throw new Error("AssetGraph.removeRelation assertion error: Relation not found in the target asset's incomingRelations array: " + relation);
        }
    ...
    /**
     * assetGraph._markContainingAssetDirtyIfInline(asset)
     * ===================================================
     *

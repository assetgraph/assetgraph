...
_.extend(AssetGraph.prototype, {
    ...
    findRelations: function (queryObj, includeUnresolved) {
    ...
    updateRelationTarget: function (relation, newTarget) {
        var oldIndex = this._indices.relation.to[relation.to.id].indexOf(relation);
        this.removeRelation(relation);
        relation.to = newTarget;
        this.addRelation(relation);
        this._indices.relation.to[relation.to.id].splice(this._indices.relation.to[relation.to.id].indexOf(relation), 1);
        this._indices.relation.to[relation.to.id].splice(oldIndex, 0, relation);
        this.refreshRelationUrl(relation);
    },

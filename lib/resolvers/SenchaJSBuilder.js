...
SenchaJSBuilder.prototype = {
    ...
    resolvePkg: function (pkg, cb) {
        ...
        seq()
            .extend(pkg.packages || [])
            .parEach(function (pkgTargetFileName) {
                ...
                that.resolvePkg(that.pkgIndex[pkgTargetFileName], this);
            })
            .seq(function () {
            ...
            .empty()
            .extend((pkg.files || []).map(function (fileDef) {
            ...
            .seq(function () {
                if (pkg.name === 'Ext Base') {
                    ...
                    this(null, this.stack); // Preserve the stack
                }
            })
            .flatten()
            .parMap(function (url) {

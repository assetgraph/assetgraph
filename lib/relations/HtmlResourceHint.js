...
class HtmlResourceHint extends HtmlRelation {
    ...
    get contentType() {
        if ('_contentType' in this) {
            ...
            if (!this._contentType || this._contentType === 'application/octet-stream')  {
                ...
                var betterContentType = extensionToTypeMap[getExtension(this.to.url)];
    ...
    get requestDestination() {
        ...
        const firstOtherIncomingRelation = incomingRelations && incomingRelations.find(relation => relation !== this);

...
Object.assign(JavaScriptWorklet, {
  selector:
    '!CallExpression[arguments.length=1][arguments.0.type=Literal] > MemberExpression.callee:has(Identifier.object) > Identifier.property[name=addModule]',
  handler(node, stack, asset) {

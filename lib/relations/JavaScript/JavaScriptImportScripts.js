...
Object.assign(JavaScriptImportScripts, {
  selector:
    'CallExpression:has(Identifier.callee[name=importScripts], MemberExpression.callee[computed=false]:has(Identifier.object[name=self]) > Identifier.property[name=importScripts])',
  handler(node, stack) {

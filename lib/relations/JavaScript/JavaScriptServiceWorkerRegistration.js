...
Object.assign(JavaScriptServiceWorkerRegistration, {
  selector:
    '!CallExpression > MemberExpression.callee[property.name=register] > MemberExpression.object[object.name=navigator][property.name=serviceWorker]',
  handler(node) {

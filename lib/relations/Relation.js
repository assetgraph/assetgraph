...
Relation.prototype = {
     ...
     * =================================
     *
     * Either 'absolute', 'rootRelative', or 'relative' (the default). Decides what "degree" of
    ...
    get baseAsset() {
        ...
        if (baseAssetPath) {
            ...
            throw new Error(this.from.urlOrDescription + ' ' + this.toString() + ': No baseAsset found');
        }
    },
    ...
    resolve: function (cb) {
        ...
        this.from.assetGraph.resolveAssetConfig(this.to, this.baseAsset.url, passError(cb, function (resolvedAssetConfigs) {

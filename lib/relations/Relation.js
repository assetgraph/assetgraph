...
class Relation {
    ...
    inline() {
        ...
        if (!this.to.isInline) {
            if (this.assetGraph) {
                for (const affectedRelation of this.to.externalRelations) {
    ...
    attach(asset, position, adjacentRelation) {
        this.from = asset;
        this.from.markDirty();
        this.addToOutgoingRelations(asset, position, adjacentRelation);
    ...
    addToOutgoingRelations(asset, position, adjacentRelation) {

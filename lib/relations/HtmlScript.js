...
extendWithGettersAndSetters(HtmlScript.prototype, {
    ...
    inline: function () {
        ...
        this.node.appendChild(this.from.parseTree.createTextNode(this.to.text.replace(/<\/script(?=[\/ >])/gi, '<\\/script'))); // Safety hack for UglifyJS: https://github.com/mishoo/UglifyJS/issues/164
        this.from.markDirty();
        return this;
    },

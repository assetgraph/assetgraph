...
class JavaScriptFetch extends Relation {
  static get selectors() {
    return {
      'CallExpression[arguments.0=(Literal[value=type(string)])][callee=(:matches(Identifier[name=fetch], MemberExpression[computed=false][property=(Identifier[name=fetch])][object=(Identifier[name=window])]))]'(
        node,

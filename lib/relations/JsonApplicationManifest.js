...
function JsonApplicationManifest(config) {
    HtmlRelation.call(this, config);
}

util.inherits(JsonApplicationManifest, HtmlRelation);

extendWithGettersAndSetters(JsonApplicationManifest.prototype, {
    get href() {
...
module.exports = JsonApplicationManifest;

...
extendWithGettersAndSetters(HtmlRelation.prototype, {
    ...
    // Also, relations found inside Html in Rss assets need to be interpreted as relative to the Rss asset.
    baseAssetQuery: query.or({type: 'Rss', isInline: false}, {type: 'Html', isInline: false, isFragment: false}),

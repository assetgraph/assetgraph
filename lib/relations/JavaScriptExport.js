...
class JavaScriptExport extends Relation {
    ...
    attach(position, adjacentRelation) {
        ...
        if (position === 'before' || position === 'after') {
            ...
            if (i === -1) {
                throw new Error('JavaScriptExport#attach: adjacentRelation.node not found in adjacentRelation.from.parseTree.body');
            }
    ...
    detach() {
        ...
        if (i === -1) {
            throw new Error('relations.JavaScriptExport#detach: this.node not found in this.from.parseTree.body.');
        }

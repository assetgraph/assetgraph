...
class MsApplicationConfigPollingUri extends Relation {
  static getRelationsFromNode(node) {
    if (
      ...
      node.matches(
        'browserconfig > msapplication > badge > polling-uri, msapplication > notification > polling-uri, msapplication > notification > polling-uri2, msapplication > notification > polling-uri3, msapplication > notification > polling-uri4, msapplication > notification > polling-uri5'
      )
    ) {
      return {

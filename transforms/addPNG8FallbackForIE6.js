...
exports.addPNG8FallbackForIE6 = function addPNG8FallbackForIE6 (siteGraph, cb) {
    var imageInfosById = {};
    siteGraph.findRelations('type', 'CSSBackgroundImage').filter(function (relation) {
        return relation.to.type === 'PNG';
    ...
    step(
        ...
        error.passToFunction(cb, function (pngQuantedImageSrcs) {
            imageInfos.forEach(function (imageInfo, i) {
                ...
                siteGraph.registerAsset(pngQuantedAsset);
                ...
                if (siteGraph.findRelations('to', imageInfo.asset).length === 0) {
                    siteGraph.unregisterAsset(imageInfo.asset);
                }
            });
            cb(null, siteGraph);
        })

...
describe('assets/Svg', function () {
    it('should handle a combo test case with an Svg asset', async function () {
        const assetGraph = new AssetGraph({root: pathModule.resolve(__dirname, '../../testdata/assets/Svg/combo/')});
        ...
        const svgAnchor = assetGraph.findRelations({type: 'SvgAnchor'})[0];
        ...
        const svgFontFaceUri = assetGraph.findRelations({type: 'SvgFontFaceUri'})[0];

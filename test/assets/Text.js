    ...
    describe('#text', function () {
        describe('invoked as a getter', function () {
            it('should get text of Text asset with rawSrc property', function () {
                expect(new AssetGraph().addAsset({type: 'Text', rawSrc: new Buffer('Hello, world!\u263a')}).text, 'to equal', 'Hello, world!\u263a');
            });

            it('should get text of AssetGraph.Text with text property', function () {
                expect(new AssetGraph().addAsset({type: 'Text', text: 'Hello, world!\u263a'}).text, 'to equal', 'Hello, world!\u263a');
            });
        });

        describe('invoked as a setter', function () {
            it('should update the text', function () {
                const textAsset = new AssetGraph().addAsset({type: 'Text', rawSrc: new Buffer('Hello, world!\u263a')});
                textAsset.text = 'foo';
    ...
    describe('#rawSrc', function () {
        ...
        describe('invoked as a setter', function () {
            it('should update the rawSrc', function () {
                const asset = new AssetGraph().addAsset({type: 'Asset', rawSrc: new Buffer('Hello, world!\u263a')});

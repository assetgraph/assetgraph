...
describe('transforms/minifySvgAssetsWithSvgo', function () {
  ...
  it('should not throw away too much precision', async function () {
    ...
    expect(
      assetGraph.findAssets({ type: 'Svg' })[0].text,
      'to equal',
      '<svg xmlns="http://www.w3.org/2000/svg" width="69.964" height="11.535" viewBox="0 0 69.964 11.535" xml:space="preserve"><path fill="#fff" d="M32.988 8.093c-.587 0-1.062.478-1.062 1.06 0 .586.475 1.059 1.062 1.059.584 0 1.058-.473 1.058-1.059-.001-.583-.474-1.06-1.058-1.06z"/></svg>'
    );
  });
});

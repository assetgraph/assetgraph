...
describe('transforms/inlineHtmlTemplates', function () {
    it('should handle a test case with Knockout.js templates loaded using the systemjs-tpl plugin', function () {

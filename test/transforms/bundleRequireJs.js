...
describe('transforms/bundleRequireJs', function () {
    ...
    it('should support the wrap option', function () {
        return new AssetGraph({root: __dirname + '/../../testdata/transforms/bundleRequireJs/wrap/'})
            .loadAssets('index.html')
            .populate()
            .bundleRequireJs()
            .queue(function (assetGraph) {
    ...
    */
    ...
    describe('with a data-almond attribute', function () {
        it('should handle a non-almond test case', function () {
            return new AssetGraph({root: __dirname + '/../../testdata/transforms/bundleRequireJs/almond/mixed/'})
        ...
        it('should handle a test case with several data-almond attributes', function () {
            return new AssetGraph({root: __dirname + '/../../testdata/transforms/bundleRequireJs/almond/mixed/'})
        ...
        it('should handle a test case where multiple Html assets use the same require.js and have a data-almond attribute', function () {
            return new AssetGraph({root: __dirname + '/../../testdata/transforms/bundleRequireJs/almond/multipleHtml/'})
                .loadAssets('*.html')
                .populate({from: {type: 'Html'}, followRelations: {type: 'HtmlScript', to: {url: /^file:/}}})
                .populate()
                .queue(function (assetGraph) {
